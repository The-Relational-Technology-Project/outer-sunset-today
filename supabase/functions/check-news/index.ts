...
CRIME & SAFETY: Only include crime stories if they represent an ACTIVE, ONGOING safety concern where neighbors need to take precautions RIGHT NOW — e.g., a suspect at large in the neighborhood, a hazardous situation, or a police advisory to avoid an area. EXCLUDE all of the following: arrests, arraignments, court proceedings, plea hearings, sentencing, investigations, charges filed, bail decisions, trials, and any story where the incident is in the past and no current action is needed from residents. If the danger has passed, the story does not belong here. When in doubt about a crime story, LEAVE IT OUT.
